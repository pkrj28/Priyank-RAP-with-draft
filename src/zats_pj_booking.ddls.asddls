...
define view entity ZATS_PJ_BOOKING as select from /dmo/booking_m
composition[1..*] of ZATS_PJ_BOOKSUPPL as _BookingSupplement
association to parent ZATS_PJ_TRAVEL as _Travel on
